...
class AnalysisError extends Error {
  ...
  getUserFriendlyMessage() {
    const userMessages = {
      'PDF_PROCESSING_FAILURE': 'This PDF file couldn\'t be processed. It may be corrupted or password-protected.',
      'IMAGE_ANALYSIS_FAILURE': 'This image couldn\'t be analyzed. Please check the file format and try again.',
      ...
      'MODEL_VERIFICATION_FAILED': 'AI model verification failed. Please check your Ollama installation.',
      ...
      'FILE_SIZE_EXCEEDED': 'File is too large for processing. Please use a smaller file.'
    };
  ...
  getActionableSteps() {
    const actions = {
      ...
      'FILE_TYPE_UNSUPPORTED': ['Convert file to supported format', 'Check supported file types in documentation']
    };
