...
export function FileOperationSkeleton({ count = 3 }) {
...
export function SmartFolderSkeleton({ count = 4 }) {
  return <div className="space-y-6">
    {Array.from({ length: count }).map((_, index) => (
      <div key={index} className="card">
        <div className="flex items-center justify-between">
...
export function FileAnalysisSkeleton({ count = 5 }) {
...
export function DirectoryScanSkeleton() {
