...
function DiscoverPhase() {
  ...
  return (
          ...
          >
            ...
            <h3 className="text-on-glass text-xl font-bold mb-2">
      ...
      case 'files':
        return (
          <div className="glass-card p-12 text-center">
            ...
            <h3 className="text-on-glass text-xl font-bold mb-4">Select Files</h3>
            <button
      ...
      case 'folder':
        return (
          <div className="glass-card p-12 text-center">
            <div className="text-6xl mb-4">📂</div>
            <h3 className="text-on-glass text-xl font-bold mb-4">Select Folder</h3>
            <button
      ...
      case 'scan':
        return (
          <div className="glass-card p-12 text-center">
            <div className="text-6xl mb-4">🔍</div>
            <h3 className="text-on-glass text-xl font-bold mb-4">System Scan</h3>
            <p className="text-readable-light mb-4">
  ...
  const renderFileList = () => {
    ...
    return (
      <div className="glass-card p-6 max-h-64 overflow-hidden">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-on-glass text-lg font-bold">
        ...
        <div className="space-y-2 max-h-32 overflow-y-auto glass-scroll">
          {selectedFiles.slice(0, 5).map((file, index) => (
            <div key={index} className="flex items-center justify-between p-2 bg-white/10 rounded-lg">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-on-glass font-medium text-sm">{file.name}</p>
                  <p className="text-readable-light text-xs">{file.type}</p>
                      </div>
                    </div>
          ...
          {selectedFiles.length > 5 && (
            <p className="text-readable-light text-center text-sm">
