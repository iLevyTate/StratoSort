...
describe('StratoSort React App', () => {
  ...
  describe('Undo/Redo System', () => {
    ...
    test('undo/redo component file exists', () => {
      const undoRedoSystemPath = path.join(__dirname, '../src/renderer/components/UndoRedoSystem.jsx');
      const useUndoRedoPath = path.join(__dirname, '../src/renderer/components/useUndoRedo.js');
      // Either the component or the hook should exist
      expect(fs.existsSync(undoRedoSystemPath) || fs.existsSync(useUndoRedoPath)).toBe(true);
    });
  });
